...
@interface DSDrHeaderView () <UIScrollViewDelegate>
...
@implementation DSDrHeaderView

+ (instancetype)headerView
{
    return [[[NSBundle mainBundle] loadNibNamed:@"DSDrHeaderView" owner:nil options:nil] lastObject];
}
