...
-(void)addAll {
    if ((self.xl_buttonNames.count || self.xl_views.count) && self.xl_buttonNames.count !=self.xl_views.count) {
        ...
        self.xl_buttonNames =self.xl_buttonNames?self.xl_buttonNames:@[@"电商",@"O2O",@"电商"];
...
-(void)addScroll1{
    ...
    self.view2 =[[UIView alloc]initWithFrame:CGRectMake(_x0,CGRectGetMaxY(button0.frame)-(self.xl_buttonToSlider?self.xl_buttonToSlider:10), size0.width, self.xl_sliderHeight?self.xl_sliderHeight:0)];
